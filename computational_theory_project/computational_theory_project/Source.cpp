...
int main()
{
	...
	cout << "/************************************************************************************************************\ \n";
	cout << endl << endl << endl;
	cout << "\t\t\t Theory Of Computing Project \t\t\n\n\n";
	cout << "/************************************************************************************************************\ \n\n\n\n";
	while (true)
	{
		cout << "\t To Generate Random strings from regular Expression Enter 1\n";
		cout << "\t To Check if string match regular expression enter 2\n";
		cout << "\t To convert regular expression to DFA enter 3\n";
		cout << "\t To Close enter 4\n";
		int val;
		cin >> val;
		if (val == 1)
			GenerateStrings();
